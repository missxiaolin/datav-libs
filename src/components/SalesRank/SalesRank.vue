      ...
      headerData.value = [
        {
          ...
          img:
            "http://missxiaolin.com/TB1Z171qebviK0jSZFNXXaApXXa-30-29.png",
        },
        {
          title: currentData[1].city,
          img:
            "http://missxiaolin.com/TB1b8Tzq7T2gK0jSZFkXXcIQFXa-28-24.png",
        },
        {
          title: currentData[2].city,
          img:
            "http://missxiaolin.com/TB12MbzqYY1gK0jSZTEXXXDQVXa-28-30.png",
        },
      ];
